...
#define PR_INT_TRACE(...) ::parrot::Log::getInternalLogger()->trace(__VA_ARGS__)
#define PR_INT_INFO(...)  ::parrot::Log::getInternalLogger()->info(__VA_ARGS__)
#define PR_INT_WARN(...)  ::parrot::Log::getInternalLogger()->warn(__VA_ARGS__)
#define PR_INT_ERROR(...) ::parrot::Log::getInternalLogger()->error(__VA_ARGS__)
#define PR_INT_FATAL(...) ::parrot::Log::getInternalLogger()->fatal(__VA_ARGS__)
