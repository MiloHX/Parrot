...
namespace parrot {
    ...
    void Renderer2D::init() {
        ...
        //s_data.vertex_buffer = VertexBuffer::create(sizeof(vertices));
        ...
        // s_data.vertex_buffer->setData(vertices, sizeof(vertices));

        //uint32_t indices[6] = { 0, 1, 2, 2, 3, 0 };
        uint32_t* quad_indices = new uint32_t[s_data.max_indices_per_draw];
        uint32_t offset = 0;
        for (uint32_t i = 0; i < s_data.max_indices_per_draw; i += 6) {
        ...
        index_buffer = IndexBuffer::create(quad_indices, s_data.max_indices_per_draw);
    ...
    void Renderer2D::flush(){
        RenderCommand::drawIndexed(s_data.vertex_array, s_data.index_count); // Temp
    }
    ...
    void Renderer2D::drawQuad(
        ...
        s_data.vertex_buffer_pointer->position   = position;// glm::vec3{-0.5f, -0.5f, 0.0f };
        s_data.vertex_buffer_pointer->color      = color; // glm::vec4{ 1.0f,  1.0f, 1.0f, 1.0f };
        s_data.vertex_buffer_pointer->text_coord = glm::vec2{ 0.0f, 0.0f };
        s_data.vertex_buffer_pointer++;

        s_data.vertex_buffer_pointer->position   = glm::vec3{ position.x + size.x, position.y, position.z }; //glm::vec3{ 0.5f, -0.5f, 0.0f };
        s_data.vertex_buffer_pointer->color      = color; // glm::vec4{ 1.0f,  1.0f, 1.0f, 1.0f };
        s_data.vertex_buffer_pointer->text_coord = glm::vec2{ 1.0f, 0.0f };
        s_data.vertex_buffer_pointer++;

        s_data.vertex_buffer_pointer->position   = glm::vec3{ position.x + size.x, position.y + size.y, position.z }; // glm::vec3{ 0.5f,  0.5f, 0.0f };
        s_data.vertex_buffer_pointer->color      = color; // glm::vec4{ 1.0f,  1.0f, 1.0f, 1.0f };
        s_data.vertex_buffer_pointer->text_coord = glm::vec2{ 1.0f, 1.0f };
        s_data.vertex_buffer_pointer++;

        s_data.vertex_buffer_pointer->position   = glm::vec3{ position.x, position.y + size.y, position.z }; // glm::vec3{-0.5f,  0.5f, 0.0f };
        s_data.vertex_buffer_pointer->color      = color; // glm::vec4{ 1.0f,  1.0f, 1.0f, 1.0f };
