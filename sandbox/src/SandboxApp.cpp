...
public:
    ExmapleLayer() : 
        ...
        m_tr_vertex_array = parrot::VertexArray::create();
        ...
        tr_vertex_buffer = parrot::VertexBuffer::create(vertices, sizeof(vertices));
        ...
        tr_index_buffer = parrot::IndexBuffer::create(indices, sizeof(indices) / sizeof(uint32_t));
        ...
        // Square Vertex Array
        m_sq_vertex_array = parrot::VertexArray::create();
        ...
        sq_vertex_buffer = parrot::VertexBuffer::create(sq_vertices, sizeof(sq_vertices));
        ...
        sq_index_buffer = parrot::IndexBuffer::create(sq_indices, sizeof(sq_indices) / sizeof(uint32_t));
    ...
    void onUpdate(parrot::TimeStep time_step) override {
        ...
        std::dynamic_pointer_cast<parrot::OpenGLShader>(m_sq_shader)->uploadUniformFloat3("u_color", m_color);
...
private:
    ...
    glm::vec3                            m_color = glm::vec3{ 0.2f, 0.3f, 0.8f };
};
